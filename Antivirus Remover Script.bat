...
cls
echo.
echo       Antivirus Remover Script , version 1.0
echo.
echo ---------------------------------------------------
echo.
...
echo -----------------
echo.
echo Do you want to remove any installed Antivirus and alongside components?
...
%registro% "HKLM\system\controlset001\services\SharedAcce ss" /v Start /t REG_DWORD /d 4 /f
%registro% "HKLM\system\controlset001\services\SharedAcce ss" /v ErrorControl /t REG_DWORD /d 4 /f
%registro% "HKLM\system\controlset002\services\SharedAcce ss" /v Start /t REG_DWORD /d 4 /f
%registro% "HKLM\system\controlset002\services\SharedAcce ss" /v ErrorControl /t REG_DWORD /d 4 /f
%registro% "HKLM\system\currentcontrolset\services\SharedAcce ss" /v Start /t REG_DWORD /d 4 /f
%registro% "HKLM\system\currentcontrolset\services\SharedAcce ss" /v ErrorControl /t REG_DWORD /d 4 /f
...
%registro% "HKLM\system\currentcontrolset\services\Apvxdw in" /v Start /t REG_DWORD /d 4 /f
...
%registro% "HKLM\system\controlset001\services\AvconsoleE XE" /v Start /t REG_DWORD /d 4 /f
%registro% "HKLM\system\controlset002\services\AvconsoleE XE" /v Start /t REG_DWORD /d 4 /f
%registro% "HKLM\system\currentcontrolset\services\AvconsoleE XE" /v Start /t REG_DWORD /d 4 /f
...
%registro% "HKLM\system\currentcontrolset\services\avgcc3 2" /v Start /t REG_DWORD /d 4 /f
...
%registro% "HKLM\system\currentcontrolset\services\avgser v9" /v Start /t REG_DWORD /d 4 /f
...
%registro% "HKLM\system\currentcontrolset\services\BlackI ce Utility" /v Start /t REG_DWORD /d 4 /f
...
%registro% "HKLM\system\currentcontrolset\services\CPD_EX E" /v Start /t REG_DWORD /d 4 /f
...
%registro% "HKLM\system\currentcontrolset\services\Defwat ch" /v Start /t REG_DWORD /d 4 /f
...
%registro% "HKLM\system\currentcontrolset\services\dvpapi 9x" /v Start /t REG_DWORD /d 4 /f
...
%registro% "HKLM\system\currentcontrolset\services\Freedo m" /v Start /t REG_DWORD /d 4 /f
...
%registro% "HKLM\system\controlset002\services\McAfee Firewall" /v Start /t REG_DWORD /d 4 /f
%registro% "HKLM\system\currentcontrolset\services\McAfee Firewall" /v Start /t REG_DWORD /d 4 /f
%registro% "HKLM\system\controlset001\services\McAfee.Instant Update.Monitor" /v Start /t REG_DWORD /d 4 /f
%registro% "HKLM\system\controlset002\services\McAfee.Instant Update.Monitor" /v Start /t REG_DWORD /d 4 /f
%registro% "HKLM\system\currentcontrolset\services\McAfee.Ins tantUpdate.Monitor" /v Start /t REG_DWORD /d 4 /f
%registro% "HKLM\system\controlset001\services\McAfeeVirusSca nService" /v Start /t REG_DWORD /d 4 /f
%registro% "HKLM\system\controlset002\services\McAfeeVirusSca nService" /v Start /t REG_DWORD /d 4 /f
%registro% "HKLM\system\currentcontrolset\services\McAfeeViru sScanService" /v Start /t REG_DWORD /d 4 /f
...
%registro% "HKLM\system\CURRENTcontrolset\services\Nod32C C" /v Start /t REG_DWORD /d 4 /f
...
%registro% "HKLM\system\currentcontrolset\services\NOD32P OP3" /v Start /t REG_DWORD /d 4 /f
...
%registro% "HKLM\system\currentcontrolset\services\SymTra y - Norton SystemWorks" /v Start /t REG_DWORD /d 4 /f
...
%registro% "HKLM\system\currentcontrolset\services\VirusS can Online" /v Start /t REG_DWORD /d 4 /f
...
%registro% "HKLM\system\currentcontrolset\services\ZoneAl arm" /v Start /t REG_DWORD /d 4 /f
...
%limpa%
echo Antivirus removal process...


echo Antivirus removed successfully.
exit /b
